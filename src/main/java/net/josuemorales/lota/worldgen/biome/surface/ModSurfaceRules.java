package net.josuemorales.lota.worldgen.biome.surface;
...
public class ModSurfaceRules {
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        SurfaceRules.RuleSource grassSurface =
                SurfaceRules.sequence(SurfaceRules.ifTrue(isAtOrAboveWaterLevel, GRASS_BLOCK), DIRT);

        return SurfaceRules.sequence(
                //                SurfaceRules.sequence(
                //                        SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.SACRED_GROVE_BIOME),
