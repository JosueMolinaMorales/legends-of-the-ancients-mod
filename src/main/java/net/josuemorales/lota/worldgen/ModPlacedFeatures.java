...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> RUNE_STONE_ORE_PLACED_KEY = registerKey("rune_stone_ore_placed");
...
//    public static final ResourceKey<PlacedFeature> END_SAPPHIRE_ORE_PLACED_KEY = registerKey("end_sapphire_ore_placed");
    public static final ResourceKey<PlacedFeature> SACRED_GROVE_PLACED_KEY = registerKey("sacred_grove_placed");

    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        HolderGetter<ConfiguredFeature<?, ?>> configuredFeatures = context.lookup(Registries.CONFIGURED_FEATURE);

        register(context, RUNE_STONE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_RUNE_STONE_ORE_KEY),
                ModOrePlacement.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
        register(context, SACRED_GROVE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.SACRED_GROVE_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2), ModBlocks.SACRED_GROVE_SAPLING.get()));
...
//                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(LegendsOfTheAncientsMod.MOD_ID, name));
    }
